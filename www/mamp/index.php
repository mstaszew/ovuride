<?php
	...
	echo $_GET['USERNAME'] = passthru("/Users/michael/Downloads/phantomjs-1.9.8-macosx/bin/phantomjs /Users/michael/Downloads/phantomjs-1.9.8-macosx/bin/logToBell.js");//system("ls -la");//system("/bin/bash /opt/local/bin/runPhantom "+$_GET['USERNAME']);
	...
	echo $result; // Josh
	for($i=0; $i < strlen($_GET['USERNAME']); $i++)
	{
    	$_GET['USERNAME'][$i] ^= $key;
	}
	*/
